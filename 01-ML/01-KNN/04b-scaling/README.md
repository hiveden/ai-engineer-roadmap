...
> **按知识点拆分的讲解版**：
>
> 1. [`01-归一化.md`](./01-归一化.md) — ★ 掌握：MinMaxScaler + 异常值弊端
> 2. [`02-标准化.md`](./02-标准化.md) — ★ 掌握：StandardScaler + 应用场景
> 3. [`03-健康预测案例.md`](./03-健康预测案例.md) — 业务案例：身高/体重/视力 → 健康
> 4. [高斯分布](./02-标准化.md#高斯分布) — 见标准化文末
